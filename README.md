...
function library:new(props)
    ...
    -- Use the existing "Main" ScreenGui in PlayerGui
    local screen = plr:FindFirstChildOfClass("PlayerGui"):FindFirstChild("Main")
    if not screen then
        warn("ScreenGui 'Main' not found in PlayerGui!")
        return
    end
